...
export const Hero = () => {
  return (
    <section className="bg-gray-light pb-[30px] mb-[-15px]">
      <Container className="relative">
        <div className="mb-[52px]">
          <motion.div
            ...
            className="absolute z-10 top-[-257px] left-[-111px] w-[471px] h-[453px] rounded-full bg-white pointer-events-none"
          ></motion.div>
          <motion.h1
            initial="hidden"
            whileInView="visible"
            ...
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInAnimation({ y: 20, delay: 0.3 })}
            className="max-w-[293px] relative z-20 text-[28px] leading-[100%] tracking-[-0.05em] uppercase text-olive mb-5 font-bold"
          >
            Відкрийте новий рівень догляду{' '}
            <span className="block lg:hidden">за собою</span>
          </motion.h1>
          <motion.p
            initial="hidden"
            whileInView="visible"
        ...
        <motion.div
          ...
          className="lg:hidden relative left-[50%] mt-[-86px] mb-[-127px] -translate-x-1/2 pointer-events-none w-[454px] h-auto"
        >
        ...
        >
          ...
          >
            <div className="w-full px-[10px] py-[15px] bg-transparent">
              <div className="flex pb-[15px] border-b border-[#FFFFFF54] mb-[10px]">
                <p className="text-[13px] leading-[110%] tracking-[-0.04em] text-white mr-[5px] max-w-[198px]">
              ...
              <Callback
                ...
                buttonClassName="px-[20px] py-[12px] text-[16px] leading-[100%] tracking-[-0.05em] text-black font-medium bg-white text-left"
